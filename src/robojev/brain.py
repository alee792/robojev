...
class Brain:
    def __init__(self, cfg: Config):
        ...
        self.last_set_down_xy: tuple[float, float] | None = None   # where the robot last released an object (survives new requests within a run; nothing is stored outside the run)
